...
export default function AISideNavbar({ 
  ...
  const handleToggle = () => {
    // On mobile/tablet, close the mobile nav
    if (window.innerWidth < 1024 && setMobileNavOpen) { // 1024px is typical tablet breakpoint
  ...
  return (
    ...
    >
      <div className="flex flex-col items-end">
        ...
        <button onClick={handleToggle} className="mt-[20px] text-primary-600">
