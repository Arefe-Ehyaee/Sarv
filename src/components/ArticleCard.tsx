...
function ArticleCard({ title, subtitle }: ArticleCardProps) {
    return (
        <div className="bg-secondary-50 rounded-[26px] border border-secondary-100 p-6 desktop:w-[608px] desktop:h-[700px] tablet:w-[696px] tablet:h-[650px] w-[358px] h-[660px] flex flex-col justify-between">
            <div>
                <img src={image} alt="image" className="rounded-[20px] desktop:w-[560px] h-[373px] tablet:w-[648px] w-[310px] object-cover" />
                ...
                <div className="desktop:mt-[32px] tablet:mt-[34px] mt-[46px]">
                    <div className="flex flex-row items-center justify-between desktop:text-sm font-myVazirFaNumRegular">
                        <p className="flex flex-row items-center gap-1">
                            <p className="text-gray-800">زمان مطالعه:</p>
                            <p className="text-gray-500">4 دقیقه</p>
                        </p>
                    ...
                    <div className="flex flex-col mt-5">
                        ...
                        <h4 className="font-myPeydaMedium desktop:text-[32px] tablet:text-[28px] mobile:text-[22px]">{title}</h4>
            ...
            <div className="flex flex-row items-center justify-between bg-background-BG desktop:w-[560px] h-12 rounded-xl px-[6px]">
