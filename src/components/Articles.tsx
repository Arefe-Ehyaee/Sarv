    ...
    return (
        <div className="mt-[150px] desktop:px-[96px] tablet:px-6 xs:px-4 text-gray-950">
            ...
            <div className="grid grid-cols-1 desktop:grid-cols-2 gap-[32px] place-items-center">
                <ArticleCard title={"۵ راه ساده برای محافظت از سلامت روان"} subtitle={"با عاداتی کوچک و روزمره، حال دلتان را بهتر کنید."} bgColor={"bg-secondary-50"} />
                <ArticleCard title={"چگونه خواب بهتر داشته باشیم؟"} subtitle={"نکاتی کاربردی برای بهبود کیفیت خواب شما."} bgColor={"bg-secondary-100"} />
                <ArticleCard title={"تغذیه سالم در زندگی روزمره"} subtitle={"راهنمایی برای یک رژیم غذایی متعادل و سالم."} bgColor={"bg-secondary-100"} />
                <ArticleCard title={"مدیریت استرس در محیط کار"} subtitle={"راهکارهایی برای آرامش بیشتر در فضای کاری."} bgColor={"bg-secondary-100"} />
            </div>
        </div>
    );
}
