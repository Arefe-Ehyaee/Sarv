...
function HowWorksCard({ title, description, icon }: ServiceCardProps) {
  return (
    ...
    <div className="relative bg-secondary-50 pt-4 px-[20px] pb-[28px] border border-secondary-100 rounded-3xl w-full flex-1 min-h-[150px] flex flex-col text-Gray-950">
