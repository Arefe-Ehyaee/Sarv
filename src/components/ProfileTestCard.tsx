...
function ProfileTestCard({ testName, description, image }: ProfileTestCardProps) {
    ...
    return (
        <div className="flex flex-col justify-between desktop:w-[435px] h-[340px] mx-auto bg-background-BG rounded-[20px] border border-primary-100 py-[20px] px-6 relative overflow-hidden">
            {/* Tilted Badge */}
