...
function ProfileTestCard({ testName, description, image }: ProfileTestCardProps) {
    ...
    return (
        <div className="flex flex-col justify-between desktop:w-[435px] h-[252px] mx-auto bg-background-BG rounded-[20px] border border-primary-100 py-[18px] px-5 relative overflow-hidden">
            ...
            <div className="flex flex-row gap-4 items-center mt-[10px] mb-[20px]">
                <p className="flex flex-row gap-[2px]"> <Clock className="text-Gray-400 w-6 h-6"></Clock> <span className="text-Gray-400 desktop:text-base font-myVazirFaNumRegular">10 دقیقه</span> </p>
                <p className="flex flex-row gap-[2px]"> <Award className="text-success-700 w-6 h-6"></Award> <span className="text-success-700 desktop:text-base font-myVazirFaNumRegular">امتیاز 16 از 20</span> </p>
